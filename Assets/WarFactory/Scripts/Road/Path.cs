...
public class PathV2
{
    ...
    public PathV2(Vector2 centre)
    {
        Debug.Log("Path Create:" + centre);
...
public class PathV3
{
    ...
    public PathV3(Vector3 centre)
    {
        Debug.Log("Path Create:" + centre);
        points = new List<Vector3>
        {
            centre+Vector3.left,
            centre+(Vector3.left+Vector3.back)*.5f,
            centre + (Vector3.right+Vector3.forward)*.5f,
    ...
    {
        //Control Point for Last Anchor Point
        points.Add(points[points.Count - 1] * 2 - points[points.Count - 2]);
        //Control Point for New Anchor Point
        points.Add((points[points.Count - 1] + anchorPos) * .5f);
        //Anchour Point
        points.Add(anchorPos);
